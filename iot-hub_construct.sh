...
project_dir="/jpom/server-2.4.6-release/data/build/1e95e2dad1b84192a2627f6856030437/source/"
target_dir="/jpom/server-2.4.6-release/data/build/1e95e2dad1b84192a2627f6856030437/source/target/"
...
mvnBuild(){
	...
	then
               mkdir -p /jpom/server-2.4.6-release/data/build/1e95e2dad1b84192a2627f6856030437/source/target
		cd ${target_dir}
...
cp -r ${project_dir}/lib ${project_dir}/target
cp -r ${project_dir}/hub/target/hub-service.jar ${project_dir}/target		
